...
const (
	ZFLogin             = "/xtgl/login_slogin.html"
	ZFLoginPublicKey    = "/xtgl/login_getPublicKey.html"
	ZFLoginCaptchaLogin = "/zfcaptchaLogin?&instanceId=zfcaptchaLogin&name=zfdun_captcha.js"
	ZFCaptchaLogin      = "/zfcaptchaLogin?instanceId=zfcaptchaLogin"
